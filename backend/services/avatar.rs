...
async fn all(db: Data<Database>, storage: Data<Storage>, auth: Auth) -> HttpResponse {
    ...
    mfiles.push(FileInfo {
        id: 1,
        key: "key".to_string(),
        name: "Avatar One".to_string(),
        url: Some("https://cataas.com/cat?width=100&height=100".to_string()),
    });
    mfiles.push(FileInfo {
        id: 2,
        key: "key".to_string(),
        name: "Avatar Two".to_string(),
        url: Some("https://cataas.com/cat/cute?width=100&height=100".to_string()),
    });
    mfiles.push(FileInfo {
        id: 3,
        key: "key".to_string(),
        name: "Avatar Three".to_string(),
        url: Some("https://cataas.com/cat?width=100&height=100".to_string()),
    });
    mfiles.push(FileInfo {
        id: 4,
        key: "key".to_string(),
        name: "Avatar Four".to_string(),
        url: Some("https://cataas.com/cat/says/hello?width=100&height=100".to_string()),
    });

    HttpResponse::Ok().json(mfiles)
}
